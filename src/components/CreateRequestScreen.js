      ...
      <ScrollView>
        ...
        <View>
          ...
          <View
            ...
            /> */}
              <CustomText style={styles.textInput} text={route.params.requestData.asset} textColor={'black'} />
            </View>
            ...
            /> */}
            <CustomText style={styles.textInput} text={route.params.requestData.room + ' , ' + route.params.requestData.subdivision + ' , ' + route.params.requestData.unit} textColor={'black'} />
